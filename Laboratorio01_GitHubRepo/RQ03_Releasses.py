...
# Consulta GraphQL com paginação buscando pelas Tags
query = """
query ($cursor: String) {
...
while len(lista_resp) < TOTAL_REQ:
    ...
    if response.status_code == 200:
        ...
        for repo in repositories:
            ...
            # Utilizando .get() para extrair de forma segura o total de Tags
            tags_count = repo.get('refs', {}).get('totalCount', 0)
            ...
            print(f"[{len(lista_resp)}/{TOTAL_REQ}] Repository: {name_with_owner} | Tags: {tags_count}")
...
# Gerando arquivo CSV
with open('tags.csv', mode='w', newline='', encoding='utf-8') as csv_file:
    # colunas do arquivo
    colunas = ['Repositorio', 'Criado Em', 'Estrelas', 'Tags']
...
print("Arquivo CSV 'tags.csv' criado com sucesso!")