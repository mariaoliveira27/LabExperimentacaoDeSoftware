'''\
Execução oficial das rodadas de Vinicius (Lab 02 - Sprint 02).
\
São executadas as soluções manual disponíveis para os katas 01, 02 e 06.
\
...
# Definição das rodadas de Vinicius (3 manuais e 3 IA via Gemini)
RODADAS = [
    {
        "kata": "kata01",
        "tratamento": "manual",
        "arquivo": SOLUCOES_DIR / "kata01_vinicius_manual.py",
        "trial_id": "vinicius_K01_manual_01",
        "duracao_min": 8.45,
    },
    {
        "kata": "kata02",
        "tratamento": "manual",
        "arquivo": SOLUCOES_DIR / "kata02_vinicius_manual.py",
        "trial_id": "vinicius_K02_manual_01",
        "duracao_min": 18.20,
    },
    {
        "kata": "kata03",
        "tratamento": "ia",
        "arquivo": SOLUCOES_DIR / "kata03_gemini_ia.py",
        "trial_id": "vinicius_K03_ia_01",
        "duracao_min": 6.50,
    },
    {
        "kata": "kata04",
        "tratamento": "ia",
        "arquivo": SOLUCOES_DIR / "kata04_gemini_ia.py",
        "trial_id": "vinicius_K04_ia_01",
        "duracao_min": 22.40,
    },
    {
        "kata": "kata05",
        "tratamento": "ia",
        "arquivo": SOLUCOES_DIR / "kata05_gemini_ia.py",
        "trial_id": "vinicius_K05_ia_01",
        "duracao_min": 9.15,
    },
    {
        "kata": "kata06",
        "tratamento": "manual",
        "arquivo": SOLUCOES_DIR / "kata06_vinicius_manual.py",
        "trial_id": "vinicius_K06_manual_01",
        "duracao_min": 19.80,
    },
]


def copiar_rq3_vinicius() -> None:
    """Copia o arquivo rq3_static_metrics.csv para a pasta de resultados do Vinicius.
    O arquivo fonte está na raiz do projeto.
    """
    src = RAIZ_REPOSITORIO / "rq3_static_metrics.csv"
    dst_dir = DIRETORIO_RESULTADOS_PADRAO / "vinicius"
...
def executar_todas() -> None:
    print("=" * 70)
    print("🚀 EXECUTANDO AS RODADAS DE VINICIUS (LAB 02)")
    print("=" * 70)
    ...
    for idx, rodada in enumerate(RODADAS, 1):
        print(f"\n[{idx}/{len(RODADAS)}] Executando rodada: {rodada['trial_id']} ({rodada['kata'].upper()} - {rodada['tratamento'].upper()})...")
    ...
    # Copia o rq3 conforme solicitado
    copiar_rq3_vinicius()

    print("\n" + "=" * 70)
    print("🎉 TODAS AS RODADAS DE VINICIUS FORAM CONCLUÍDAS COM SUCESSO!")
