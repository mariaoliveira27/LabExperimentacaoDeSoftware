"""Execução oficial das rodadas de Vinícius (Lab 02 - Sprint 02).

Rodadas já disponíveis (tratamento manual):
1. K01 manual (vinicius_K01_manual_01)
2. K02 manual (vinicius_K02_manual_01)
3. K06 manual (vinicius_K06_manual_01)
...
def executar_todas() -> None:
    print("=" * 70)
    print("🚀 EXECUTANDO AS 3 RODADAS OFICIAIS DE VINICIUS (LAB 02)")
    print("=" * 70)
    ...
    for idx, rodada in enumerate(RODADAS, 1):
        print(f"\n[{idx}/3] Executando rodada: {rodada['trial_id']} ({rodada['kata'].upper()} - {rodada['tratamento'].upper()})...")
    ...
    print("\n" + "=" * 70)
    print("🎉 TODAS AS 3 RODADAS FORAM CONCLUÍDAS COM SUCESSO!")
